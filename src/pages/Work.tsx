  ...
  const projects = [
    {
      ...
      image: 'https://res.cloudinary.com/dqokf2vgg/image/upload/v1751728593/Medical_Queue_System_n8hflg.png',
      metrics: [
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/dqokf2vgg/image/upload/c_crop,ar_1:1/v1751641666/Makio_Tour_Vehicle_pfj1hq.png',
      metrics: [
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-6 max-w-6xl">
                  ...
                  <div className="flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-gray-500 dark:text-gray-400 font-mono text-sm">{project.year}</span>
                      </div>

                      {/* Problem */}
                      <div className="mb-4">
                        <h4 className="font-heading font-semibold text-gray-900 dark:text-gray-100 mb-2">
                          Problem
                        </h4>
                      ...
                      {/* Impact */}
                      <div className="mb-6">
                        <h4 className="font-heading font-semibold text-primary-600 dark:text-primary-400 mb-2">
                          Impact
                        </h4>
                            ...
                            <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                              {project.metrics.map((metric, metricIndex) => (
                                <div key={metricIndex} className="text-center">
                                  <metric.icon className="w-6 h-6 text-primary-600 dark:text-primary-400 mx-auto mb-2" />
                      ...
                      <div className="mb-6">
                        <div className="flex flex-wrap gap-2">
                          {project.tech.map((tech) => (
                            <span
                              key={tech}
                              className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-sm font-mono"
                            >
                              {tech}
                            </span>
                          ))}
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                      <motion.button
                        ...
                        className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium transition-colors duration-200 flex items-center gap-2"
                        whileHover={{ x: 5 }}
                      >
          ...
          >
            ...
            <Link to="/contact">
              <motion.button
                className="bg-primary-600 dark:bg-primary-500 text-white px-8 py-3 rounded-lg font-heading font-semibold hover:bg-primary-700 dark:hover:bg-primary-600 transition-all duration-300 inline-flex items-center gap-2"
