    ...
    <section className="py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <header className="text-center mb-16">
          <h3 className="text-4xl md:text-5xl font-bold mb-4">Selected Case Studies</h3>
        ...
        <div className="space-y-12">
          {projects.map((project) => (
            <motion.div key={project.id} layout className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden">
