...
import { MapPin, GitBranch, ArrowRight } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-5 gap-8 items-start">
            ...
            <div className="lg:col-span-3 card-elevated p-8 md:p-10">
              ...
              <div className="space-y-4 text-base leading-relaxed text-gray-600 dark:text-gray-400">
                <p>
                  I'm a Senior Software Engineer with a track record of
                  shipping production systems that move business metrics
                  from cutting clinic wait times by 40% to driving a 180%
                  conversion uplift on a travel booking platform.
                </p>

                <p>
                  My work spans the full stack: React and Next.js on the
                  frontend, .NET Core and Node.js on the backend, Azure,
                  Kubernetes, and cloud-native technologies.
                </p>

                <p>
                  Outside of client work, I contribute to open source,
                  mentor junior engineers, and stay close to the Nairobi
                  tech community.
                </p>
              </div>
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {/* KCNA Certification Card */}
              <motion.a
                href="https://www.credly.com/badges/3e4f9208-7676-4829-ac58-de445b34b56a"
                target="_blank"
                rel="noopener noreferrer"
                className="card p-6 block hover:shadow-card-md transition-all duration-300"
              ...
              >
                <div className="flex gap-4 items-center">
                  <div className="relative w-20 h-20 shrink-0">
                    <Image
                      src="https://images.credly.com/size/680x680/images/f28f1d88-428a-47f6-95b5-7da1dd6c1000/KCNA_badge.png"
                  ...
                  <div>
                    ...
                    <h3 className="font-heading text-gray-900 dark:text-gray-100">
